...
import com.lxinet.jeesns.service.member.impl.MemberClassificationServiceImpl;
...
//        model.addAttribute("model", contactMembers);
    ...
    @ResponseBody
    @Before(UserLoginInterceptor.class)
    public ResultModel save(@Valid MemberClassification memberClassification,BindingResult bindingResult ) {
